...
export default function Products() {
  ...
  return (
    ...
    <Toaster/>
      ...
      <input type="search" class="lg:w-2/3 sm:w-full mx-auto block p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-main focus:border-main " placeholder="Search"  />
